...
var recipe_1 = require("../util/recipe");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, logic_1.fetchRecipesFromAPI)()];
                case 1:
                    recipes = _a.sent();
                    recipes.forEach(function (recipe) { return (0, recipe_1.display)(recipe); });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, logic_1.searchRecipes)(searchQuery)];
                case 1:
                    recipes = _a.sent();
                    recipes.forEach(function (recipe) { return (0, recipe_1.display)(recipe); });
                    return [3 /*break*/, 3];
