...
import { addItem, deleteItem } from "../Redux/ToDoList/ToDoListSlice";
...
export const List = () => {
  ...
  if (list.length === 0) {
    ...
    contentToRender = list.map((item: ListItemType) =>
      item.isValid ? <ListItem key={item.id} {...item} /> : null
    );
  }
  ...
  return (
    <div className="item-container">
      ...
      <div className="input-wrapper">
        ...
        />
        <button className="submit" data-testid="submit" onClick={handleAddItem}>
          Submit
        </button>
      </div>
      <div className="list-container" data-testid="items">
