...
import com.kdu.springmvc.services.MapperService;
...
public class VehicleController {
    ...
    @PostMapping("/create")
    public ResponseEntity<String> createVehicle(@RequestBody String jsonPayload) {
        try {
            VehicleRequestDTO vehicleRequestDTO = MapperService.mapPayload(jsonPayload);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<String> update(@PathVariable Integer id, @RequestBody String jsonPayload) {
        try {
            VehicleRequestDTO vehicleRequestDTO = MapperService.mapPayload(jsonPayload);
